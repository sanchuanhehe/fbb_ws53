...
| 符号 | 说明 |
| --- | --- |
| ![危险](figures/zh-cn_image_0000001777393778.png) | 表示如不避免则将会导致死亡或严重伤害的具有高等级风险的危害。 |
| ![警告](figures/zh-cn_image_0000001777234118.png) | 表示如不避免则可能导致死亡或严重伤害的具有中等级风险的危害。 |
| ![小心](figures/zh-cn_image_0000001823873685.png) | 表示如不避免则可能导致轻微或中度伤害的具有低等级风险的危害。 |
| ![须知](figures/zh-cn_image_0000001823993649.png) | 用于传递设备或环境安全警示信息。如不避免则可能会导致设备损坏、数据丢失、设备性能降低或其它不可预知的结果。“须知”不涉及人身伤害。 |
| ![说明](figures/zh-cn_image_0000001823873681.png) | 对正文中重点信息的补充说明。“说明”不是安全警示信息，不涉及人身、设备及环境伤害信息。 |
