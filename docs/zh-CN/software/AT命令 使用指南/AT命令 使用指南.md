# 前言<a name="ZH-CN_TOPIC_0000001823874265"></a>
...
<tbody><tr id="row52579486"><td class="cellrowborder" valign="top" width="40.400000000000006%" headers="mcps1.1.3.1.1 "><p id="p112031718196"><a name="p112031718196"></a><a name="p112031718196"></a>WS53</p>
</td>
...
<tbody><tr id="row1372280416410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p3734547016410"><a name="p3734547016410"></a><a name="p3734547016410"></a><a name="image2670064316410"></a><a name="image2670064316410"></a><span><img class="" id="image2670064316410" src="figures/zh-cn_image_0000001777234750.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p1757432116410"><a name="p1757432116410"></a><a name="p1757432116410"></a>表示如不避免则将会导致死亡或严重伤害的具有高等级风险的危害。</p>
</td>
</tr>
<tr id="row466863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1432579516410"><a name="p1432579516410"></a><a name="p1432579516410"></a><a name="image4895582316410"></a><a name="image4895582316410"></a><span><img class="" id="image4895582316410" src="figures/zh-cn_image_0000001823994269.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p959197916410"><a name="p959197916410"></a><a name="p959197916410"></a>表示如不避免则可能导致死亡或严重伤害的具有中等级风险的危害。</p>
</td>
</tr>
<tr id="row123863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1232579516410"><a name="p1232579516410"></a><a name="p1232579516410"></a><a name="image1235582316410"></a><a name="image1235582316410"></a><span><img class="" id="image1235582316410" src="figures/zh-cn_image_0000001777234746.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p123197916410"><a name="p123197916410"></a><a name="p123197916410"></a>表示如不避免则可能导致轻微或中度伤害的具有低等级风险的危害。</p>
</td>
</tr>
<tr id="row5786682116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p2204984716410"><a name="p2204984716410"></a><a name="p2204984716410"></a><a name="image4504446716410"></a><a name="image4504446716410"></a><span><img class="" id="image4504446716410" src="figures/zh-cn_image_0000001777394410.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p4388861916410"><a name="p4388861916410"></a><a name="p4388861916410"></a>用于传递设备或环境安全警示信息。如不避免则可能会导致设备损坏、数据丢失、设备性能降低或其它不可预知的结果。</p>
<p id="p1238861916410"><a name="p1238861916410"></a><a name="p1238861916410"></a>“须知”不涉及人身伤害。</p>
</td>
</tr>
<tr id="row2856923116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p5555360116410"><a name="p5555360116410"></a><a name="p5555360116410"></a><a name="image799324016410"></a><a name="image799324016410"></a><span><img class="" id="image799324016410" src="figures/zh-cn_image_0000001823874317.png" width="47.88" height="15.96"></span></p>
</td>
...
<table><thead align="left"><tr id="row2942532716410"><th class="cellrowborder" valign="top" width="18.63%" id="mcps1.1.4.1.1"><p id="p3778275416410"><a name="p3778275416410"></a><a name="p3778275416410"></a><strong id="b5687322716410"><a name="b5687322716410"></a><a name="b5687322716410"></a>文档版本</strong></p>
</th>
<th class="cellrowborder" valign="top" width="19.75%" id="mcps1.1.4.1.2"><p id="p5627845516410"><a name="p5627845516410"></a><a name="p5627845516410"></a><strong id="b5800814916410"><a name="b5800814916410"></a><a name="b5800814916410"></a>发布日期</strong></p>
</th>
<th class="cellrowborder" valign="top" width="61.62%" id="mcps1.1.4.1.3"><p id="p2382284816410"><a name="p2382284816410"></a><a name="p2382284816410"></a><strong id="b3316380216410"><a name="b3316380216410"></a><a name="b3316380216410"></a>修改说明</strong></p>
</th>
</tr>
</thead>
<tbody><tr id="row20163195111369"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p141704914352"><a name="p141704914352"></a><a name="p141704914352"></a>06</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p131711497352"><a name="p131711497352"></a><a name="p131711497352"></a>2026-04-20</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul687319483372"></a><a name="ul687319483372"></a><ul id="ul687319483372"><li>新增“<a href="#ZH-CN_TOPIC_0000002532177168">AT+HEAPSTAT 打印堆使用情况</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002563057105">AT+TASKSTACK 打印每个任务栈使用情况</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001887310045">AT+BLECONNPARUPD 更新连接参数</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001841133168">添加属性同步</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001880996066">修改NV项</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row14927138491"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p3927981296"><a name="p3927981296"></a><a name="p3927981296"></a>05</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p11927181799"><a name="p11927181799"></a><a name="p11927181799"></a>2025-05-28</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul185561647093"></a><a name="ul185561647093"></a><ul id="ul185561647093"><li>更新“<a href="#ZH-CN_TOPIC_0000001777234638">通用AT指令</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823994205">BLE AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823874197">SLE AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001880994502">PLAT模块AT指令</a>”章节内容。</li></ul>
</td>
</tr>
<tr id="row178368363259"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p7837113618252"><a name="p7837113618252"></a><a name="p7837113618252"></a>04</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p108372364258"><a name="p108372364258"></a><a name="p108372364258"></a>2025-01-14</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul135097473254"></a><a name="ul135097473254"></a><ul id="ul135097473254"><li>更新“<a href="#ZH-CN_TOPIC_0000001823874237">通用AT指令描述</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002112884464">AT+SYSCHANIF 指定Syschannel使用的网络设备接口</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001777394366">设置SLE广播参数</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002138641345">写入用户预留位</a>”~“<a href="#ZH-CN_TOPIC_0000002143971565">AT+SETUART 配置串口功能</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row1261985812281"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p3561114715209"><a name="p3561114715209"></a><a name="p3561114715209"></a>03</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p105616476206"><a name="p105616476206"></a><a name="p105616476206"></a>2024-11-25</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul127712453111"></a><a name="ul127712453111"></a><ul id="ul127712453111"><li>更新“<a href="#ZH-CN_TOPIC_0000001823874237">通用AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001887310049">gatts模块AT命令</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823874197">SLE AT指令描述</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row25958455810"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p559516415584"><a name="p559516415584"></a><a name="p559516415584"></a>02</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p10595343584"><a name="p10595343584"></a><a name="p10595343584"></a>2024-09-13</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul05271742101813"></a><a name="ul05271742101813"></a><ul id="ul05271742101813"><li>更新“<a href="#ZH-CN_TOPIC_0000001887310045">AT+BLECONNPARUPD 更新连接参数</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002010738922">超深睡设置</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row1947687183019"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p1477175306"><a name="p1477175306"></a><a name="p1477175306"></a>01</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p1647787163017"><a name="p1647787163017"></a><a name="p1647787163017"></a>2024-08-08</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><p id="p1947719714306"><a name="p1947719714306"></a><a name="p1947719714306"></a>第一次正式版本发布。</p>
<a name="ul125021539123118"></a><a name="ul125021539123118"></a><ul id="ul125021539123118"><li>更新“<a href="#ZH-CN_TOPIC_0000001887310033">AT+BLESETADVPAR 设置广播数据参数</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001887310049">gatts模块AT命令</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row46321284110"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p1263215281612"><a name="p1263215281612"></a><a name="p1263215281612"></a>00B04</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p1863242820120"><a name="p1863242820120"></a><a name="p1863242820120"></a>2024-07-19</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul1495516963"></a><a name="ul1495516963"></a><ul id="ul1495516963"><li>更新“<a href="#ZH-CN_TOPIC_0000001823874237">通用AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001777234714">STA相关AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823994265">SoftAP相关AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001777394282">AT+RXINFO 查询常收</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823994205">BLE AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823874197">SLE AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001927074897">读取NV项</a>”、“<a href="#ZH-CN_TOPIC_0000001880996066">修改NV项</a>”、“<a href="#ZH-CN_TOPIC_0000001927095401">读取efuse mac</a>”、“<a href="#ZH-CN_TOPIC_0000001881236738">获取系统时间</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000001949157409">设置IO工作模式</a>”~“<a href="#ZH-CN_TOPIC_0000001920478168">读取GPIO的电平状态</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row18393153081520"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p439313001512"><a name="p439313001512"></a><a name="p439313001512"></a>00B03</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p6393133018158"><a name="p6393133018158"></a><a name="p6393133018158"></a>2024-06-11</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><a name="ul20652112313198"></a><a name="ul20652112313198"></a><ul id="ul20652112313198"><li>更新“<a href="#ZH-CN_TOPIC_0000001777394306">通用AT指令一览表</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001823874237">通用AT指令描述</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001944058177">BLE测试模式AT指令</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000001880994502">PLAT模块AT指令</a>”章节内容。</li></ul>
</td>
</tr>
<tr id="row262786125619"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p15627186135615"><a name="p15627186135615"></a><a name="p15627186135615"></a>00B02</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p5627196155618"><a name="p5627196155618"></a><a name="p5627196155618"></a>2024-04-03</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><p id="p14627469560"><a name="p14627469560"></a><a name="p14627469560"></a>更新“<a href="#ZH-CN_TOPIC_0000001823874257">BLE&SLE模块AT指令</a>”小节内容。</p>
</td>
</tr>
<tr id="row5947359616410"><td class="cellrowborder" valign="top" width="18.63%" headers="mcps1.1.4.1.1 "><p id="p2149706016410"><a name="p2149706016410"></a><a name="p2149706016410"></a>00B01</p>
</td>
<td class="cellrowborder" valign="top" width="19.75%" headers="mcps1.1.4.1.2 "><p id="p648803616410"><a name="p648803616410"></a><a name="p648803616410"></a>2024-01-31</p>
</td>
<td class="cellrowborder" valign="top" width="61.62%" headers="mcps1.1.4.1.3 "><p id="p1946537916410"><a name="p1946537916410"></a><a name="p1946537916410"></a>第一次临时版本发布。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="82%" headers="mcps1.1.3.5.1 "><p id="p147172018566"><a name="p147172018566"></a><a name="p147172018566"></a>参数值应为规定值，示例中961为键盘的外观值，具体请参考<a href="zh-cn_topic_0000001887214177.md">表1</a></p>
</td>
</tr>
</tbody>
</table>
