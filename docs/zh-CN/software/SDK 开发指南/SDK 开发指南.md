# 前言<a name="ZH-CN_TOPIC_0000001946360050"></a>
...
<tbody><tr id="row1372280416410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p3734547016410"><a name="p3734547016410"></a><a name="p3734547016410"></a><a name="image2670064316410"></a><a name="image2670064316410"></a><span><img class="" id="image2670064316410" src="figures/zh-cn_image_0000001973438877.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p1757432116410"><a name="p1757432116410"></a><a name="p1757432116410"></a>表示如不避免则将会导致死亡或严重伤害的具有高等级风险的危害。</p>
</td>
</tr>
<tr id="row466863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1432579516410"><a name="p1432579516410"></a><a name="p1432579516410"></a><a name="image4895582316410"></a><a name="image4895582316410"></a><span><img class="" id="image4895582316410" src="figures/zh-cn_image_0000001946200738.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p959197916410"><a name="p959197916410"></a><a name="p959197916410"></a>表示如不避免则可能导致死亡或严重伤害的具有中等级风险的危害。</p>
</td>
</tr>
<tr id="row123863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1232579516410"><a name="p1232579516410"></a><a name="p1232579516410"></a><a name="image1235582316410"></a><a name="image1235582316410"></a><span><img class="" id="image1235582316410" src="figures/zh-cn_image_0000001973438881.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p123197916410"><a name="p123197916410"></a><a name="p123197916410"></a>表示如不避免则可能导致轻微或中度伤害的具有低等级风险的危害。</p>
</td>
</tr>
<tr id="row5786682116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p2204984716410"><a name="p2204984716410"></a><a name="p2204984716410"></a><a name="image4504446716410"></a><a name="image4504446716410"></a><span><img class="" id="image4504446716410" src="figures/zh-cn_image_0000001973319145.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p4388861916410"><a name="p4388861916410"></a><a name="p4388861916410"></a>用于传递设备或环境安全警示信息。如不避免则可能会导致设备损坏、数据丢失、设备性能降低或其它不可预知的结果。</p>
<p id="p1238861916410"><a name="p1238861916410"></a><a name="p1238861916410"></a>“须知”不涉及人身伤害。</p>
</td>
</tr>
<tr id="row2856923116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p5555360116410"><a name="p5555360116410"></a><a name="p5555360116410"></a><a name="image799324016410"></a><a name="image799324016410"></a><span><img class="" id="image799324016410" src="figures/zh-cn_image_0000001946200742.png" width="47.88" height="15.96"></span></p>
</td>
...
<table><thead align="left"><tr id="row2942532716410"><th class="cellrowborder" valign="top" width="14.45%" id="mcps1.1.4.1.1"><p id="p3778275416410"><a name="p3778275416410"></a><a name="p3778275416410"></a><strong id="b5687322716410"><a name="b5687322716410"></a><a name="b5687322716410"></a>文档版本</strong></p>
</th>
<th class="cellrowborder" valign="top" width="21.16%" id="mcps1.1.4.1.2"><p id="p5627845516410"><a name="p5627845516410"></a><a name="p5627845516410"></a><strong id="b5800814916410"><a name="b5800814916410"></a><a name="b5800814916410"></a>发布日期</strong></p>
</th>
<th class="cellrowborder" valign="top" width="64.39%" id="mcps1.1.4.1.3"><p id="p2382284816410"><a name="p2382284816410"></a><a name="p2382284816410"></a><strong id="b3316380216410"><a name="b3316380216410"></a><a name="b3316380216410"></a>修改说明</strong></p>
</th>
</tr>
</thead>
<tbody><tr id="row6459181015152"><td class="cellrowborder" valign="top" width="14.45%" headers="mcps1.1.4.1.1 "><p id="p12459121051511"><a name="p12459121051511"></a><a name="p12459121051511"></a>03</p>
</td>
<td class="cellrowborder" valign="top" width="21.16%" headers="mcps1.1.4.1.2 "><p id="p74596107159"><a name="p74596107159"></a><a name="p74596107159"></a>2025-01-14</p>
</td>
<td class="cellrowborder" valign="top" width="64.39%" headers="mcps1.1.4.1.3 "><a name="ul13272152186"></a><a name="ul13272152186"></a><ul id="ul13272152186"><li><p id="p1885017363180"><a name="p1885017363180"></a><a name="p1885017363180"></a>更新“<a href="#ZH-CN_TOPIC_0000001973438865">注意事项</a>”小节内容。</p>
</li><li>更新“<a href="#ZH-CN_TOPIC_0000001973319097">编程实例</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row62298514375"><td class="cellrowborder" valign="top" width="14.45%" headers="mcps1.1.4.1.1 "><p id="p1423018514378"><a name="p1423018514378"></a><a name="p1423018514378"></a>02</p>
</td>
<td class="cellrowborder" valign="top" width="21.16%" headers="mcps1.1.4.1.2 "><p id="p823019511375"><a name="p823019511375"></a><a name="p823019511375"></a>2024-11-25</p>
</td>
<td class="cellrowborder" valign="top" width="64.39%" headers="mcps1.1.4.1.3 "><a name="ul834311185614"></a><a name="ul834311185614"></a><ul id="ul834311185614"><li>更新“<a href="#ZH-CN_TOPIC_0000001946360058">编程实例</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001946360022">编程实例</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001973438817">编程实例</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001973438841">注意事项</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row5947359616410"><td class="cellrowborder" valign="top" width="14.45%" headers="mcps1.1.4.1.1 "><p id="p2149706016410"><a name="p2149706016410"></a><a name="p2149706016410"></a>01</p>
</td>
<td class="cellrowborder" valign="top" width="21.16%" headers="mcps1.1.4.1.2 "><p id="p648803616410"><a name="p648803616410"></a><a name="p648803616410"></a>2024-08-08</p>
</td>
<td class="cellrowborder" valign="top" width="64.39%" headers="mcps1.1.4.1.3 "><p id="p1946537916410"><a name="p1946537916410"></a><a name="p1946537916410"></a>第一次正式版本发布。</p>
</td>
</tr>
</tbody>
</table>
...
│   └── ws53                        \# ws53的初始化代码，app的从汇编开始到C语言入口的初始化代码

├── bootloader                      \# boot程序代码目录

│   ├── commonboot                  \# 公共boot代码

│   └── flashboot\_ws53              \# ws53的flashboot代码

├── build                           \# 编译构建相关的脚本目录

│   ├── cmake                       \# cmake脚本代码

│   ├── config                      \# 编译构建相关的配置文件目录

│   ├── script                      \# 编译构建相关的脚本文件目录

│   └── toolchains                  \# 编译构建工具链

├── drivers                         \# 外设驱动目录

│   ├── boards                      \# 板级配置文件目录，主要是链接脚本

│   ├── chips                       \# 外设驱动的芯片适配层代码

│   └── drivers                     \# 外设驱动目录, 包含与芯片无关的纯驱动层，和外设的ip驱动

├── include                         \# 对外头文件目录

│   ├── driver                      \# 外设驱动的头文件目录

│   └── middleware                  \# 中间件的头文件目录

├── interim\_binary                  \# 二进制交付件目录

│   └── ws53                        \# ws53的二进制交付件存放目录

├── kernel                          \# 内核源码目录

│   ├── liteos                      \# liteos源码目录

│   ├── non\_os                      \# non\_os源码目录，目前用于flashboot

│   ├── osal                        \# osal接口层源码实现目录

│   └── osal\_adapt                  \# osal适配层源码实现目录

├── middleware                      \# 中间件目录

│   ├── chips                       \# 中间件的芯片适配层源码目录

│   ├── services                    \# 中间件服务模块源码目录

│   └── utils                       \# 中间件的utils实现源码目录

├── open\_source                     \# 开源组件源码目录

│   ├── 7-zip-lzma-sdk              \# 7zip-lzma源码

│   ├── cjson                       \# cjson源码

│   ├── libboundscheck              \# libboundscheck源码
...
│   └── wpa\_supplicant              \# wpa\_supplicant源码
...
Flash分区相关内容，可以参考《WS53V100 FOTA开发指南》中 《4.2 注意事项》。
