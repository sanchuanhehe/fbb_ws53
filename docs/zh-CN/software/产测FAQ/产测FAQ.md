# 前言<a name="ZH-CN_TOPIC_0000002088727844"></a>
...
**读者对象<a name="section151282013319"></a>**
...
<th class="cellrowborder" valign="top" width="20.84%" id="mcps1.1.4.1.2"><p id="p5627845516410"><a name="p5627845516410"></a><a name="p5627845516410"></a><strong id="b5800814916410"><a name="b5800814916410"></a><a name="b5800814916410"></a>发布日期</strong></p>
</th>
<th class="cellrowborder" valign="top" width="66.88%" id="mcps1.1.4.1.3"><p id="p2382284816410"><a name="p2382284816410"></a><a name="p2382284816410"></a><strong id="b3316380216410"><a name="b3316380216410"></a><a name="b3316380216410"></a>修改说明</strong></p>
</th>
</tr>
</thead>
<tbody><tr id="row112061174112"><td class="cellrowborder" valign="top" width="12.280000000000001%" headers="mcps1.1.4.1.1 "><p id="p141704914352"><a name="p141704914352"></a><a name="p141704914352"></a>04</p>
</td>
<td class="cellrowborder" valign="top" width="20.84%" headers="mcps1.1.4.1.2 "><p id="p131711497352"><a name="p131711497352"></a><a name="p131711497352"></a>2026-07-01</p>
</td>
<td class="cellrowborder" valign="top" width="66.88%" headers="mcps1.1.4.1.3 "><a name="ul159551511217"></a><a name="ul159551511217"></a><ul id="ul159551511217"><li>更新“<a href="#ZH-CN_TOPIC_0000002124327549">AT+FTM=0使用？</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000002124247261">WIFI</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row6931723161917"><td class="cellrowborder" valign="top" width="12.280000000000001%" headers="mcps1.1.4.1.1 "><p id="p59362331916"><a name="p59362331916"></a><a name="p59362331916"></a>03</p>
</td>
<td class="cellrowborder" valign="top" width="20.84%" headers="mcps1.1.4.1.2 "><p id="p093523121910"><a name="p093523121910"></a><a name="p093523121910"></a>2024-10-28</p>
</td>
<td class="cellrowborder" valign="top" width="66.88%" headers="mcps1.1.4.1.3 "><a name="ul341452918199"></a><a name="ul341452918199"></a><ul id="ul341452918199"><li>新增“<a href="#ZH-CN_TOPIC_0000002088727820">写完频偏后一定要写温度吗？</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002088567952">AT+FTM=0切APP模式失败？</a>”小节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002088727848">11n40M带宽制式使用</a>”小节内容。</li></ul>
</td>
</tr>
<tr id="row7186142519413"><td class="cellrowborder" valign="top" width="12.280000000000001%" headers="mcps1.1.4.1.1 "><p id="p71860255418"><a name="p71860255418"></a><a name="p71860255418"></a>02</p>
</td>
<td class="cellrowborder" valign="top" width="20.84%" headers="mcps1.1.4.1.2 "><p id="p101871625743"><a name="p101871625743"></a><a name="p101871625743"></a>2024-08-05</p>
</td>
<td class="cellrowborder" valign="top" width="66.88%" headers="mcps1.1.4.1.3 "><a name="ul616114372514"></a><a name="ul616114372514"></a><ul id="ul616114372514"><li>更新“<a href="#ZH-CN_TOPIC_0000002124247269">客户应该使用哪个海思固件版本和极致汇仪版本？</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000002124247261">WIFI</a>”小节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000002124247241">BLE/SLE</a>”小节内容。</li></ul>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="20.84%" headers="mcps1.1.4.1.2 "><p id="p648803616410"><a name="p648803616410"></a><a name="p648803616410"></a>2024-06-07</p>
</td>
<td class="cellrowborder" valign="top" width="66.88%" headers="mcps1.1.4.1.3 "><p id="p1946537916410"><a name="p1946537916410"></a><a name="p1946537916410"></a>第一次正式版本发布。</p>
</td>
</tr>
</tbody>
</table>
...
-   **[WS53产测版本使用场景？](#ZH-CN_TOPIC_0000002124327553)**  
...
### WS53产测版本使用场景？<a name="ZH-CN_TOPIC_0000002124327553"></a>

**问题描述<a name="section839182920469"></a>**

当前发布的SDK包有两类，一类是商用分支的1.10.XXX类型，一类是产测分支的1.10.TXXX类型，它们有什么区别？客户应该用哪个SDK包？

**解决方法<a name="section3636174715466"></a>**

1.  1.10.XXX类型SDK包，商用分支代码构建，其中产测文件二进制ws53\_liteos\_mfg.bin，海思闭源发布（sdk\\application\\ws53\\ws53\_liteos\_mfg\\ws53\_liteos\_mfg.bin），面向常规模组厂，这类模组厂对产测没有定制化要求。

    ![](figures/zh-cn_image_0000002115176196.png)

2.  1.10.TXXX类型SDK包，产测分支代码构建，客户能基于SDK源码包编译ws53\_liteos\_mfg.bin，实现产测定制化。

    ![](figures/zh-cn_image_0000002115176664.png)

3.  1.10.XXX类型SDK包和1.10.TXXX类型SDK包完全独立发布，版本号和发布时间都独立。

    注：产线只能用商用SDK包编译的ws53\_liteos\_app\_all\_in\_one.fwpkg。
...
2.  对于产测SDK包，使用./build.py -c ws53\_liteos\_mfg或者./build.py -c ws53编译ws53\_liteos\_mfg.bin，取ws53\_liteos\_mfg.bin文件，替换商用SDK包中ws53\_liteos\_mfg.bin，[参考1.1.1章节](#ZH-CN_TOPIC_0000002124327553)。
