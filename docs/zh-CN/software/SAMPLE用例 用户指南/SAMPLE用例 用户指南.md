# 前言<a name="ZH-CN_TOPIC_0000001927309102"></a>
...
<tbody><tr id="row1372280416410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p3734547016410"><a name="p3734547016410"></a><a name="p3734547016410"></a><a name="image2670064316410"></a><a name="image2670064316410"></a><span><img class="" id="image2670064316410" src="figures/zh-cn_image_0000001954627773.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p1757432116410"><a name="p1757432116410"></a><a name="p1757432116410"></a>表示如不避免则将会导致死亡或严重伤害的具有高等级风险的危害。</p>
</td>
</tr>
<tr id="row466863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1432579516410"><a name="p1432579516410"></a><a name="p1432579516410"></a><a name="image4895582316410"></a><a name="image4895582316410"></a><span><img class="" id="image4895582316410" src="figures/zh-cn_image_0000001954468025.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p959197916410"><a name="p959197916410"></a><a name="p959197916410"></a>表示如不避免则可能导致死亡或严重伤害的具有中等级风险的危害。</p>
</td>
</tr>
<tr id="row123863216410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p1232579516410"><a name="p1232579516410"></a><a name="p1232579516410"></a><a name="image1235582316410"></a><a name="image1235582316410"></a><span><img class="" id="image1235582316410" src="figures/zh-cn_image_0000001954627777.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p123197916410"><a name="p123197916410"></a><a name="p123197916410"></a>表示如不避免则可能导致轻微或中度伤害的具有低等级风险的危害。</p>
</td>
</tr>
<tr id="row5786682116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p2204984716410"><a name="p2204984716410"></a><a name="p2204984716410"></a><a name="image4504446716410"></a><a name="image4504446716410"></a><span><img class="" id="image4504446716410" src="figures/zh-cn_image_0000001927309118.png" width="55.9265" height="25.270000000000003"></span></p>
</td>
<td class="cellrowborder" valign="top" width="79.42%" headers="mcps1.1.3.1.2 "><p id="p4388861916410"><a name="p4388861916410"></a><a name="p4388861916410"></a>用于传递设备或环境安全警示信息。如不避免则可能会导致设备损坏、数据丢失、设备性能降低或其它不可预知的结果。</p>
<p id="p1238861916410"><a name="p1238861916410"></a><a name="p1238861916410"></a>“须知”不涉及人身伤害。</p>
</td>
</tr>
<tr id="row2856923116410"><td class="cellrowborder" valign="top" width="20.580000000000002%" headers="mcps1.1.3.1.1 "><p id="p5555360116410"><a name="p5555360116410"></a><a name="p5555360116410"></a><a name="image799324016410"></a><a name="image799324016410"></a><span><img class="" id="image799324016410" src="figures/zh-cn_image_0000001954468021.png" width="47.88" height="15.96"></span></p>
</td>
...
<tbody><tr id="row1948893273920"><td class="cellrowborder" valign="top" width="20.05%" headers="mcps1.1.4.1.1 "><p id="p64882032153913"><a name="p64882032153913"></a><a name="p64882032153913"></a>05</p>
</td>
<td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.1.4.1.2 "><p id="p7488123273912"><a name="p7488123273912"></a><a name="p7488123273912"></a>2025-05-28</p>
</td>
<td class="cellrowborder" valign="top" width="57.04%" headers="mcps1.1.4.1.3 "><a name="ul8259754103911"></a><a name="ul8259754103911"></a><ul id="ul8259754103911"><li>新增“<a href="#ZH-CN_TOPIC_0000002246014070">SLE CHBA</a>”章节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002281478949">SLE CHBA&SYSCHANNEL</a>”章节内容。</li></ul>
</td>
</tr>
<tr id="row19549135021211"><td class="cellrowborder" valign="top" width="20.05%" headers="mcps1.1.4.1.1 "><p id="p154925014123"><a name="p154925014123"></a><a name="p154925014123"></a>04</p>
</td>
<td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.1.4.1.2 "><p id="p3549950111215"><a name="p3549950111215"></a><a name="p3549950111215"></a>2025-01-14</p>
</td>
<td class="cellrowborder" valign="top" width="57.04%" headers="mcps1.1.4.1.3 "><p id="p2946133418146"><a name="p2946133418146"></a><a name="p2946133418146"></a>更新“<a href="#ZH-CN_TOPIC_0000001928723088">编译</a>”章节内容。</p>
</td>
</tr>
<tr id="row14931031103419"><td class="cellrowborder" valign="top" width="20.05%" headers="mcps1.1.4.1.1 "><p id="p3561114715209"><a name="p3561114715209"></a><a name="p3561114715209"></a>03</p>
</td>
<td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.1.4.1.2 "><p id="p105616476206"><a name="p105616476206"></a><a name="p105616476206"></a>2024-11-25</p>
</td>
<td class="cellrowborder" valign="top" width="57.04%" headers="mcps1.1.4.1.3 "><a name="ul1660315793618"></a><a name="ul1660315793618"></a><ul id="ul1660315793618"><li>更新“<a href="#ZH-CN_TOPIC_0000001928723088">编译</a>”章节内容。</li><li>新增“<a href="#ZH-CN_TOPIC_0000002119845181">UART</a>”章节内容。</li></ul>
</td>
</tr>
<tr id="row1331762592410"><td class="cellrowborder" valign="top" width="20.05%" headers="mcps1.1.4.1.1 "><p id="p1131719256248"><a name="p1131719256248"></a><a name="p1131719256248"></a>02</p>
</td>
<td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.1.4.1.2 "><p id="p15317142514247"><a name="p15317142514247"></a><a name="p15317142514247"></a>2024-09-13</p>
</td>
<td class="cellrowborder" valign="top" width="57.04%" headers="mcps1.1.4.1.3 "><a name="ul4490225182514"></a><a name="ul4490225182514"></a><ul id="ul4490225182514"><li>更新“<a href="#ZH-CN_TOPIC_0000001954630725">SPI</a>”章节内容。</li><li>更新“<a href="#ZH-CN_TOPIC_0000001927312054">QSPI</a>”章节内容。</li></ul>
</td>
</tr>
<tr id="row5947359616410"><td class="cellrowborder" valign="top" width="20.05%" headers="mcps1.1.4.1.1 "><p id="p2149706016410"><a name="p2149706016410"></a><a name="p2149706016410"></a>01</p>
</td>
<td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.1.4.1.2 "><p id="p648803616410"><a name="p648803616410"></a><a name="p648803616410"></a>2024-08-08</p>
</td>
<td class="cellrowborder" valign="top" width="57.04%" headers="mcps1.1.4.1.3 "><p id="p1946537916410"><a name="p1946537916410"></a><a name="p1946537916410"></a>第一次正式版本发布。</p>
</td>
</tr>
</tbody>
</table>
...
![](figures/选择ADC-channel.png "选择ADC-channel")
...
![](figures/选择BLINKY-Sample.png "选择BLINKY-Sample")

**图 2**  选择BLINKY pin<a name="fig1252148173414"></a>  
![](figures/选择BLINKY-pin.png "选择BLINKY-pin")
...
![](figures/zh-cn_image_0000001935078354.png)
...
1.  在命令行下执行命令“python build.py ws53\_liteos\_app menuconfig”，打开menuconfig配置界面。
2.  在menuconfig界面中选择SFC Sample，如[图1](#fig106431326122119)所示；如果需要修改配置选项，则继续按[图2 SFC Config配置](#fig56435266213)选择，建议修改地址为预留区，若地址在镜像区或其他区域可能导致程序挂死，需要重新烧录，预留区地址可参考《WS63V100 FOTA 开发指南》<4.2注意事项\>；选择完成后按“Q”或者“q”选择“y”保存退出。
3.  使用IDE编译版本，编译出的版本包在“output\\ws53\\fwpkg\\pack\_all\_core\\ws53\_liteos\_app”路径下，如[图3](#fig116431126152115)所示。
4.  将编译出的版本烧录到单板。

**图 1**  选择SFC Sample<a name="fig106431326122119"></a>  
![](figures/选择SFC-Sample.png "选择SFC-Sample")
...
![](figures/zh-cn_image_0000002166603601.png)
...
![](figures/zh-cn_image_0000002000722404.png)
...
![](figures/编辑QSPI-Config.png "编辑QSPI-Config")
...
![](figures/qspi-4线模式写psram.png "qspi-4线模式写psram")
...
**图 2**  编译后的fwpkg<a name="fig116431126152115"></a>  
![](figures/编译后的fwpkg-12.png "编译后的fwpkg-12")
...
![](figures/编译后的fwpkg-13.png "编译后的fwpkg-13")
...
![](figures/选择中断模式.png "选择中断模式")

**图 3**  编译后的fwpkg<a name="fig1889013402418"></a>  
![](figures/编译后的fwpkg-14.png "编译后的fwpkg-14")
...
本示例描述了WS53对通W53，星闪接入ip打流的操作方法。

![](figures/zh-cn_image_0000002331509593.png)
...
![](figures/选择chba-sample.png "选择chba-sample")

**图 2**  编译后的fwpkg<a name="fig04501428621"></a>  
![](figures/编译后的fwpkg-15.png "编译后的fwpkg-15")
...
![](figures/zh-cn_image_0000002297466582.png)
...
**图 1**  选择chba sample<a name="fig1739611132615"></a>  
![](figures/选择chba-sample-16.png "选择chba-sample-16")
...
**图 3**  星闪建链<a name="fig86041630123011"></a>  
![](figures/星闪建链-18.png "星闪建链-18")

**图 4**  关闭扫描<a name="fig134409333311"></a>  
![](figures/关闭扫描-19.png "关闭扫描-19")

**图 5**  连接参数更新<a name="fig10609171633920"></a>  
![](figures/连接参数更新-20.png "连接参数更新-20")
