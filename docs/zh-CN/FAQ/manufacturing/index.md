# 常见问题<a name="ZH-CN_TOPIC_0000002088567968"></a>

本文汇总 WS53 使用过程中常见的问题及处理方法。

-   **[WiFi](#ZH-CN_TOPIC_0000002088727840)**  

-   **[BLE/SLE](#ZH-CN_TOPIC_0000002088567972)**  
...
有些校准值存在NV区域，参考[NV项汇总](../../guides/system/nv/index.md#ZH-CN_TOPIC_0000001886269022)；有些校准值写到efuse。
...
5.  若客户使用自己开发的产测软件平台，校验命令执行结果是否正确请参考产测工具的[测试命令](../../guides/manufacturing/production-tooling/index.md#ZH-CN_TOPIC_0000001873275652)章节中每一条命令的执行状态返回字段，status：<value\> ，value = 0 表示成功，其他的表示失败。
