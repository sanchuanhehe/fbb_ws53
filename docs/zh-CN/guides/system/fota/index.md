...
1.  <a name="li8171529465"></a>编译生成带签名的明文新镜像。编译生成镜像请参见 [开发环境搭建详解](../../../get-started/environment-setup/manual/index.md) 中“编译方法”章节。
...
-   分区ID最大规格支持16个，从0x30开始的分区ID，可以定制开发，无特殊要求，不建议删除分区ID，如果预留区空间过小，希望增加预留区空间，可以从imageA/imageB/fota data分区切割部分空间，调整方法请参考 [开发环境搭建详解](../../../get-started/environment-setup/manual/index.md) 中“Flash分区表配置”章节。
