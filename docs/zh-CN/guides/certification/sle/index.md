...
![](figures/zh-cn_image_0000001993106469.png)
...
![](figures/zh-cn_image_0000001993226693.png)
...
![](figures/zh-cn_image_0000001993106485.png)
...
![](figures/zh-cn_image_0000001993106473.png)

### 认证启动测试<a name="ZH-CN_TOPIC_0000001993226673"></a>

![](figures/zh-cn_image_0000001993226697.png)
...
星闪认证用例详细描述请参见《星闪无线通信 低功耗技术要求和测试方法》。
...
1.  下载软件，启动星闪服务：星闪协议认证 使用BTC only版本，接串口小板使用（位置J16）。
    ...
    ![](figures/zh-cn_image_0000001993106481.png)
...
产测版本可以使用AT命令进行星闪射频认证测试，详细可参考《WS53V100系列射频测试用户指南》
