...
- [ADC（Analog-to-Digital Converter）](adc.md)
- [DMA（Direct Memory Access）](dma.md)
- [eFuse Core](efuse/core.md)
- [eFuse User](efuse/user.md)
- [GPIO（General Purpose Input/Output）](gpio.md)
- [I2C（Inter-Integrated Circuit）](i2c.md)
- [I2S（Inter-IC Sound）](i2s.md)
- [Pinctrl](pinctrl.md)
- [PWM（Pulse Width Modulation）](pwm.md)
- [SDIO（Secure Digital Input/Output）](sdio.md)
