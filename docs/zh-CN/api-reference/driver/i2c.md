...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待初始化的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
...
| 返回值 | 文字含义 | 触发场景 |
| -------- | -------- | -------- |
| ERRCODE_SUCC:0x00 | 执行成功 | 参数合法，初始化成功 |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待执行写操作的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
| dev_addr | uint16_t | 主机发送数据的目标从机地址 | 0x00 ~ 0x7F（7 位从机地址；实现未做额外边界校验） |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待执行读操作的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
| dev_addr | uint16_t | 主机接收数据的目标从机地址 | 0x00 ~ 0x7F（7 位从机地址；实现未做额外边界校验） |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待执行写读操作的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
| dev_addr | uint16_t | 主机写读数据的目标从机地址 | 0x00 ~ 0x7F（7 位从机地址；实现未做额外边界校验） |
...
| addr | uint16_t | I2C 作为从机工作时的从机地址 | 7 比特地址 [0x8, 0x77] / 10 比特地址 [0x7800, 0x7BFF] |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待配置的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
| irq_en | bool | 是否使用中断模式传输数据 | true / false |
...
| 返回值 | 文字含义 | 触发场景 |
| -------- | -------- | -------- |
| ERRCODE_SUCC:0x00 | 执行成功 | 参数合法，模式设置成功 |
| Other | 其他错误码，参考[errcode_t](#typedef_errcode_t) | 执行失败 |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待注册回调的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待取消注册回调的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
...
| 返回值 | 文字含义 | 触发场景 |
| -------- | -------- | -------- |
| ERRCODE_SUCC:0x00 | 执行成功 | 回调取消注册成功 |
| Other | 其他错误码，参考[errcode_t](#typedef_errcode_t) | 执行失败 |
...
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待配置的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
| en | bool | 是否使能 DMA 模式传输 | true / false |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待去初始化的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | [i2c_bus_t](#i2c_bus_t) | 待重置波特率的 I2C 总线编号 | [I2C_BUS_0](#i2c_bus_t):0 / [I2C_BUS_1](#i2c_bus_t):1 / [I2C_BUS_NONE](#i2c_bus_t):2 |
...
| 返回值 | 文字含义 | 触发场景 |
| -------- | -------- | -------- |
| ERRCODE_SUCC:0x00 | 执行成功 | 参数合法，波特率重置成功 |
| Other | 其他错误码，参考[errcode_t](#typedef_errcode_t) | 执行失败 |
