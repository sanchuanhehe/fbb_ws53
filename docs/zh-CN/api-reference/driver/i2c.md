...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待初始化的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
| baudrate | uint32_t | I2C 波特率，受 IP 上限约束 | 0 ~ [I2C_HS_MODE_BAUDRATE_HIGH_LIMIT](#I2C_HS_MODE_BAUDRATE_HIGH_LIMIT)(3400000) |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待执行写操作的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
| dev_addr | uint16_t | 主机发送数据的目标从机地址 | 不为 0 |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待执行读操作的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
| dev_addr | uint16_t | 主机接收数据的目标从机地址 | 不为 0 |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待执行写读操作的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
| dev_addr | uint16_t | 主机写读数据的目标从机地址 | 不为 0 |
...
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待初始化的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
| baudrate | uint32_t | I2C 波特率，需与主机保持一致，受 IP 上限约束 | 0 ~ [I2C_HS_MODE_BAUDRATE_HIGH_LIMIT](#I2C_HS_MODE_BAUDRATE_HIGH_LIMIT)(3400000) |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待配置的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待注册回调的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待取消注册回调的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待去初始化的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| bus | i2c_bus_t | 待重置波特率的 I2C 总线编号 | I2C_BUS_0(0) / I2C_BUS_1(1) |
| baudrate | uint32_t | 重置后的 I2C 波特率，受 IP 上限约束 | 0 ~ [I2C_HS_MODE_BAUDRATE_HIGH_LIMIT](#I2C_HS_MODE_BAUDRATE_HIGH_LIMIT)(3400000) |
