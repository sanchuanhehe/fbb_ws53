...
| 名称 | 参数类型 | 说明 | 约束取值范围 |
| ---- | ---- | ---- | ---- |
| mode | [protocol_mode_enum](#enum_protocol_mode_enum) | 协议模式 | [protocol_mode_enum](#enum_protocol_mode_enum) 全体成员 |
...
| 返回值 | 文字含义 | 触发场景 |
| -------- | -------- | -------- |
| ERRCODE_SUCC：0 | 执行成功 | 快速连接请求发起成功 |
| Other | 其他错误码，参考[errcode_t](#typedef_errcode_t) | 执行失败 |
