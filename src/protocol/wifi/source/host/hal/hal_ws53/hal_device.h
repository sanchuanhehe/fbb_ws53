...
osal_u8 get_sar_pwr_limit(osal_void);
osal_s16 hal_get_txpwr_by_dbb_scaling(osal_u16 dbb_scaling_idx, osal_u16 dbb_scaling_base);
...
oal_bool_enum_uint8 hal_is_hw_tx_queue_empty(const hal_to_dmac_device_stru *hal_device);

osal_u8 hal_device_rf_chain_get_phy_chain(osal_u8 rf_chain);
osal_u32 hal_device_update_phy_chain(hal_to_dmac_device_stru *hal_device, oal_bool_enum_uint8 set_channel);
osal_void hal_set_phy_rf_chain_relation(hal_to_dmac_device_stru *hal_device, oal_bool_enum_uint8 set_channel);
osal_u32 hal_m2s_handle_event(hal_to_dmac_device_stru *hal_device, osal_u16 type, osal_u16 datalen, osal_u8 *data);
osal_u8 hal_device_get_m2s_mask(osal_void);
osal_u8 hal_device_get_protocol_idx(osal_u8 idx);
osal_u8 hal_device_get_legacy_rate_idx(osal_u8 idx);
osal_u8 hal_device_get_htvht_rate_idx(osal_u8 idx);
