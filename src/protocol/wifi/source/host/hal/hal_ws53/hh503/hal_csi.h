...
// csi全局配置接口
osal_u32 hal_csi_set_global_cfg(const hal_csi_global_cfg *cfg);
osal_u32 hal_csi_get_global_cfg(hal_csi_global_cfg *cfg);
...
osal_u32 hal_csi_stat_get(hal_csi_stat *stat);
