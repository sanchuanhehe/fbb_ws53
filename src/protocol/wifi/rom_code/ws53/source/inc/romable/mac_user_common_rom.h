...
typedef struct {
    ...
    /* ht cap */
    oal_bool_enum_uint8 ht_capable : 1;        /* HT capable */
    osal_u8 max_rx_ampdu_factor : 2;           /* Max AMPDU Rx Factor */
    osal_u8 min_mpdu_start_spacing : 3;        /* Min AMPDU Start Spacing */
    osal_u8 htc_support : 1;                   /* HTC 域支持 */
    osal_u8 resv : 1;
