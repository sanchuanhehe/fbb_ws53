...
static sle_dev_manager_callbacks_t g_sle_hello_dev_mgr_cbk = {0};
...
static void sle_hello_sle_enable_cbk(uint8_t status)
{
...
static void sle_hello_seek_cbk_register(void)
{
    g_sle_hello_dev_mgr_cbk.sle_enable_cb = sle_hello_sle_enable_cbk;
    ...
    sle_dev_manager_register_callbacks(&g_sle_hello_dev_mgr_cbk);
