...
#else
#define UUID_SERVER_PROPERTIES (GATT_CHARACTER_PROPERTY_BIT_READ | GATT_CHARACTER_PROPERTY_BIT_INDICATE | \
                                GATT_CHARACTER_PROPERTY_BIT_WRITE_NO_RSP)
#endif

/* ATT protocol overhead for an MTU-sized value. */
#define BLE_HEAD_BYTE 3
