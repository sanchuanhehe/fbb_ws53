...
#define NON_OS_BT_NMI_MASK_REG        NMI_CTL_REG_BASE_ADDR
#define NON_OS_BT_NMI_STATUS_REG      (NMI_CTL_REG_BASE_ADDR + 0x4)
#define NON_OS_BNMI_GLE_INT_FLAG      BIT(NMI_GLE)
#define NON_OS_BNMI_BLE_INT_FLAG      BIT(NMI_BLE)
#define NON_OS_BNMI_BWDT_INT_FLAG     NON_OS_NMI_CWDT_INT_FLAG
