...
/**
 * @defgroup drivers_port_dma_v120 DMA V120
...
#define HAL_DMA_HANDSHAKING_UART_L_TX HAL_DMA_HANDSHAKING_UART_H1_TX
#define HAL_DMA_HANDSHAKING_UART_L_RX HAL_DMA_HANDSHAKING_UART_H1_RX
...
/**
 * @brief  Get the base address of a specified DMA.
 * @return The base address of specified DMA.
 */
uintptr_t dma_porting_base_addr_get(void);

/**
 * @brief  Register hal funcs objects into hal_dma module.
 */
void dma_port_register_hal_funcs(void);

/**
 * @brief  Unregister hal funcs objects from hal_dma module.
 */
 ...
 * @brief  lock for dma.
 */
uint32_t dma_porting_lock(void);

/**
 * @brief  unlock for dma.
 */
void dma_porting_unlock(uint32_t irq_sts);
