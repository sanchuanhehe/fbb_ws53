...
#define BURN_EFUSE_BIN_ADDR 0x20030000
...
#define EFUSE_FLASHBOOT_ROLLBACK_VERSION 1160
#define EFUSE_APP_ROLLBACK_VERSION       1120
#define EFUSE_BYTE_TO_BIT                8
#define EFUSE_FLASHBOOT_VERSION_SIZE     1
#define EFUSE_APP_VERSION_SIZE           4
...
#define CUSTOM_RESVED_EFUSE_LEN_START_BYTE_ADDR 234
#define CUSTOM_RESVED2_EFUSE_BYTE_LEN 16
#define CUSTOM_RESVED2_EFUSE_LEN_START_BYTE_ADDR 106
#define CUSTOM_RESVED3_EFUSE_LEN_START_BYTE_ADDR 122
#define EFUSE_SIZE_1_BYTS 1
#define HASH_ROOT_PUBLIC_KEY_LEN 32
#define EFUSE_SSI_MASK_START_BIT 385
#define EFUSE_FUNC_JTAG_MASK_START_BIT 384
#define EFUSE_DFT_JTAG_MASK_START_BIT 386
#define EFUSE_HASH_ROOT_PUBLIC_KEY_START_BIT 848
#define EFUSE_SEC_VERIFY_ENABLE_START_BIT 1168
#define CUSTOMER_RSVD_EFUSE_START_BIT  1872
...
typedef enum {
    ...
    EFUSE_MAC_ADDR_01_ID = 8,
    EFUSE_MAC_ADDR_02_ID = 9,
    EFUSE_MAC_ADDR_03_ID = 10,
    EFUSE_MAC_ADDR_LAST_ID = 11,
    EFUSE_CUSTOM_RESVED_ID = 12,
    EFUSE_CUSTOM_RESVED2_ID = 13,
    EFUSE_IDX_MAX,
} efuse_idx;

#define EFUSE_SECOND_FLASHBOOT_VER_ID   EFUSE_PARAMS_VER_ID
