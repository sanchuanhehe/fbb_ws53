...
#if defined(__LITEOS__) || defined(__FREERTOS__) || defined(__RTTHREAD__)
 ...
 *
 *
 * @param init_handle [in] Task initialization structure.
 * @param topStack [in] Task stack
 *
 * @retval   osal_task*  If the thread is successfully created, the pointer of the thread is returned.
 * @retval   NULL        If the thread fails to be created, NULL is returned.
 *
 ...
 *
 * @param task [in] Thread to be suspended.
 *
 * @par Support System:
 * liteos.
 */
 ...
 *
 * @param task [in] Thread to be resumed.
 *
 * @par Support System:
 * liteos.
 */
 ...
 *
 * @par Description:
 * This API is used to init kernel.
 *
 * @return OSAL_FAILURE/OSAL_SUCCESS.
 *
 * @par Support System:
 ...
 *
 * @par Description:
 * This API is used to start kernel.
 *
 * @return OSAL_FAILURE/OSAL_SUCCESS.
 *
 * @par Support System:
...
/**
 * @ingroup osal_task
 * @brief Obtaining the Kernel Status.
 *
 * @par Description:
 * This API is used to get the status of kernel.
 *
 * @return osal_kernel_status.
 *
 * @par Support System:
 * liteos.
 */
