/*
 * Copyright (c) HiSilicon (Shanghai) Technologies Co., Ltd.. 2010-2022. All rights reserved.
...
// #warning you should redefine OSAL_PROC_DIR. default is osal_proc
#define OSAL_PROC_DIR "osal_proc"
