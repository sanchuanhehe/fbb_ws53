...
#define EXT_DRV_MEDIA_DEVICE_NAME_MAX_LEN 64

#define EXT_DRV_MEDIA_DEVICE_MAJOR 218
#define EXT_DRV_MEDIA_DYNAMIC_MINOR 255
...
typedef struct ext_umap_device {
    char devfs_name[EXT_DRV_MEDIA_DEVICE_NAME_MAX_LEN]; /* devfs */
    int minor;
