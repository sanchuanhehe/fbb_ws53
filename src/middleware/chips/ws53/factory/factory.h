...
#define FLASH_256K_SIZE 0x40000 /* 256K */

#define ERRCODE_FACTORY_FLASH_WRITE_ERROR 0x80003150
#define ERRCODE_FACTORY_FLASH_READ_ERROR 0x80003151
#define ERRCODE_FACTORY_MEMCMP_VERIFY_ERROR 0x80000006
