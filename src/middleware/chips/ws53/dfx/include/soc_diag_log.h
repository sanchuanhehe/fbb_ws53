...
#define diag_log_msg_mk_id_lev(id, mod_id, lev) (((uint32_t)(1UL << 31)) + (((uint32_t)((mod_id) << 27)) & 0x78000000) \
    + (((uint32_t)(THIS_FILE_ID << 17)) & 0x7fe0000) + ((((uint32_t)(check_default_id(id))) << 3) & 0x1fff8) \
    + ((lev) & 0x7))
...
#define uapi_diag_lev_log0(id, mod_id, lev, fmt) \
    oam_log_print0_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id))
#define uapi_diag_lev_log1(id, mod_id, lev, fmt, p1) \
    oam_log_print1_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id), p1)
#define uapi_diag_lev_log2(id, mod_id, lev, fmt, p1, p2) \
    oam_log_print2_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id), p1, p2)
#define uapi_diag_lev_log3(id, mod_id, lev, fmt, p1, p2, p3) \
    do { \
        zdiag_log_msg3_t log_msg = {p1, p2, p3}; \
        oam_log_print3_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id), &log_msg); \
    } while (0)
#define uapi_diag_lev_log4(id, mod_id,  lev, fmt, p1, p2, p3, p4) \
    do { \
        zdiag_log_msg4_t log_msg = {p1, p2, p3, p4}; \
        oam_log_print4_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id), &log_msg); \
    } while (0)
#define uapi_diag_lev_log(id, mod_id, lev, fmt, args...) \
    do { \
        oam_log_print_alterable_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id), \
            var_args_cnt(unused, ##args), ##args); \
    } while (0)
#define uapi_diag_lev_log_buff(id, mod_id, lev, log_info, data_size, fmt, type) \
    oam_log_print_buff_press_prv(diag_log_msg_mk_id_lev(id, mod_id, lev), diag_log_msg_mk_mod_id(mod_id), \
        log_info, data_size)
