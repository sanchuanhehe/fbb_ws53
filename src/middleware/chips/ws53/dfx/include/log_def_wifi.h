...
typedef enum {
    ...
    OAM_FILE_ID_HI11XX_RF_CORIDC_H,
    ...
    OAM_FILE_ID_HAL_HI11XX_RESET_H,
    ...
    OAM_FILE_ID_HAL_HI11XX_COEX_REG_H,
    ...
    OAM_FILE_ID_HMAC_TX_TUPLE_OPT_C,
    ...
    OAM_FILE_ID_DMAC_STA_PM_INIT_C,
    OAM_FILE_ID_HAL_PM_INIT_C,
    ...
    OAM_FILE_ID_CALI_ONLINE_IQ,
    OAM_FILE_ID_CALI_ONLINE_IQ_FSM,
    DIAG_FILE_ID_WIFI_DEV_ALG_AR_C,
    DIAG_FILE_ID_WIFI_HOST_HMAC_ACHBA_C,
    DIAG_FILE_ID_WIFI_HOST_HAL_REG_OPT_C,
    DIAG_FILE_ID_WIFI_HOST_HMAC_CRYPTO_TKIP_C,
    DIAG_FILE_ID_WIFI_HOST_HMAC_VERSION_C,
    DIAG_FILE_ID_WIFI_HOST_HMAC_RX_PK_C,
    DIAG_FILE_ID_WIFI_HOST_HMAC_TX_PK_C,
    DIAG_FILE_ID_WIFI_HOST_HMAC_STA_CHANNEL_SCORING_C,
