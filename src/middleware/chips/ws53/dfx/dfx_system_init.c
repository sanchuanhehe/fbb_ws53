...
static diag_cmd_reg_obj_t g_diag_default_cmd_tbl[] = {
    ...
    { DIAG_CMD_MEM_MEM32, DIAG_CMD_MEM_MEM8, diag_cmd_mem_operate },
#endif
    ...
    { DIAG_CMD_ID_WLAN_SAMPLE, DIAG_CMD_ID_WLAN_SAMPLE, diag_cmd_wlan_module_sample_data},
    { DIAG_CMD_ID_WLAN_PHY_SAMPLE, DIAG_CMD_ID_WLAN_PHY_SAMPLE, diag_cmd_wlan_module_sample_data},
    { DIAG_CMD_ID_SOC_SAMPLE, DIAG_CMD_ID_SOC_SAMPLE, diag_cmd_wlan_module_sample_data},
#ifdef CONFIG_MIDDLEWARE_NV_SUPPORT_HSO_ACCESS
...
#if (ENABLE_LOW_POWER == YES)
            idle_pm_update_timeout(DIAG_DELAY);
#endif
#endif
            break;
#if CONFIG_DFX_SUPPORT_TRANSMIT_FILE == DFX_YES
