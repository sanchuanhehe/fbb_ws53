...
/* AT+USLP */
at_ret_t at_set_usleep_mode(const usleep_gpio_t *args);

/* AT+FREQ */
at_ret_t at_set_freq_mode(const freqmode_args_t *args);
...
at_ret_t at_exe_soft_reset_cmd(const exe_reset_args_t *args);
...
at_ret_t cmd_set_customer_rsvd2_efuse(const customer_rsvd_efuse_args_t *args);
at_ret_t cmd_get_customer_rsvd2_efuse(void);
...
const at_para_parse_syntax_t usleepgpio_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        ...
        .offset = offsetof(usleep_gpio_t, para1)
    },
};

const at_para_parse_syntax_t freqmode_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 2,
        .offset = offsetof(freqmode_args_t, para1)
    },
};
...
const at_para_parse_syntax_t customer_rsvd2_efuse_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_STRING,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_MAX_LENGTH,
        .entry.string.max_length = 130,
        .offset = offsetof(customer_rsvd2_efuse_args_t, para1)
    },
};
...
const at_para_parse_syntax_t exe_reset_syntax[] = {
    {
        .type = AT_SYNTAX_TYPE_INT,
        .last = true,
        .attribute = AT_SYNTAX_ATTR_AT_MIN_VALUE | AT_SYNTAX_ATTR_AT_MAX_VALUE,
        .entry.int_range.min_val = 0,
        .entry.int_range.max_val = 1,
        .offset = offsetof(exe_reset_args_t, enable)
    },
};
...
const at_cmd_entry_t at_plt_cmd_parse_table[] = {
    ...
    },
    {
        ...
        usleepgpio_syntax,
        NULL,
        (at_set_func_t)at_set_usleep_mode,
        NULL,
        NULL,
    },
    {
        ...
        freqmode_syntax,
        NULL,
        (at_set_func_t)at_set_freq_mode,
        NULL,
        NULL,
    },
    {
    ...
    },
    {
        ...
        exe_reset_syntax,
        at_exe_reset_cmd,
        (at_set_func_t)at_exe_soft_reset_cmd,
        NULL,
        NULL,
    },
    {
    ...
    {
        "CUSTOMEFUSEREUSEFAPC",
        7,
        0,
        customer_rsvd2_efuse_syntax,
        NULL,
        (at_set_func_t)cmd_set_customer_rsvd2_efuse,
        cmd_get_customer_rsvd2_efuse,
        NULL,
    },
    {
        "JTAG",
