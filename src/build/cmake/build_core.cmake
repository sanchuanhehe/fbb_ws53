...
macro(cfbb_build_prologue)
    ...
    if(DEFINED ENV{build_ws53_sdk_open})
        set(build_lib true)
    else()
        set(build_lib false)
    endif()
    ...
    include_directories(${ROOT_DIR}/kernel/liteos/liteos_v208.5.0/Huawei_LiteOS/targets/ws53/include)

    if(EXISTS "${ROOT_DIR}/kernel/liteos/liteos_v208.5.0/${TARGET_COMMAND}")
        set(build_ws53_sdk_open true)
    endif ()
