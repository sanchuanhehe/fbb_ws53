...
def set_new_csv_key():
    ...
    if os.path.exists(cfg_file):
        sec_en = "\n1,sec_verify_enable,1168,1,0x1,PG0"
        root_key_hash = "\n1,root_key_hash,848,256,", get_root_key_hash() ,",PG5"
        efuse_file.writelines(sec_en)
        efuse_file.writelines(root_key_hash)

    cfg_file = os.path.join(csv_dir + "/../", 'sign_config', 'ws53_liteos_app_ecc.cfg')
    ...
    if encry_en == '1' and PlainKey != demo:
        flash_key = "\n1,otp_oem_mrk,400,128,", get_flash_key_param() ,",PG3"
